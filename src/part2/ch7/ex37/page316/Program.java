...
class Program {
	public static void main(String[] args) throws IOException {
		...
		EXIT: while (true) {
			...
			System.out.println("└────────────────────┘");
			System.out.print(" 1. 성적 입력￦n");
			System.out.print(" 2. 성적 출력￦n");
			System.out.print(" 3. 프로그램 종료￦n");
			System.out.print(" 선택 > ");
			...
			case PRINT: {
				...
				for (int i = 0; i < index; i++) {
					...
					total = kor + eng + math;
					avg = total / 3.0f;
					System.out.printf(" 시험 %d￦n---------￦n", i + 1);
			...
			case END:
				break EXIT;
			default:
				System.out.println("입력이 잘못되었습니다. 입력할 수 있는 범위는 1~3 입니다. 다시 입력해주세요");
			}
		}
	}
}